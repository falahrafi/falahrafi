...
function MainButton({ link, text, textSize, icon, iconColor, padding, rounded, width }) {
  ...
  return (
    <div className={ width + " " + "inline-block items-center justify-center"} onClick={() => navigator.vibrate(50)}>
