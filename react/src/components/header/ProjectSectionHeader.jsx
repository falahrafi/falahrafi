  ...
  return (
    <div className="flex mt-20 mb-5">
      ...
      <div className="flex-none">
        <h2 className="w-fit font-header font-bold text-4xl uppercase bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-neutral-500 mx-auto">
          {header}
        </h2>
      </div>
